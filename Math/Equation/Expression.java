...
public class Expression {
    ...
    public void genNode(String pEq){
        node = Node.generateNodes(parseTokens(pEq));
    }
    /** 
   ...
   /**
    ...
    /** 
     * Gives a String representation of this Expression. Comprised of {@link #equation}, {@link #factors}, and
     * {@link #node}.
    ...
    /** 
     * Gives a pretty-looking representation of this Expression. comprised of {@link #equation}, and {@link #factors}' 
     * {@link Factors#vars} and {@link Factors#funcs}.
     * @return A fancy String representation of this Expression.
     */
