...
{  
  ...
  /** The colors for each equation
    ...
    */
   public GraphDisplay(String[] equations, double eqBnd, double step, int winBnd, int dispBnd, 
        Color[] colors) {
      this(equations, new double[] { eqBnd }, new double[] { step }, new int[] { winBnd },
       new int[] { dispBnd }, false, colors);
   }
    ...
    */
   public GraphDisplay(String[] equations, double[] eqBnd, double[] steps, int[] winBnd, int[] dispBnd,
                          boolean isImag, Color[] colors) throws ArrayIndexOutOfBoundsException {
