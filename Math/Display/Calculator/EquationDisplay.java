...
{  
   ...
   * The color that the graph will be drawn in
    ...
    */
   public EquationDisplay(String eq, double eqBnd, double step, int winBnd, int dispBnd, 
        Color color) {
      this(eq, new double[] { eqBnd }, new double[] { step }, new int[] { winBnd },
       new int[] { dispBnd }, false,color);
   }
    ...
    */
   public EquationDisplay(String eq, double[] eqBnd, double[] steps, int[] winBnd, int[] dispBnd,
                          boolean isImag, Color color) throws ArrayIndexOutOfBoundsException {
