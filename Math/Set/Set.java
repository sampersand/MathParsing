...
public class Set implements MathObject {
    ...
    /**
     * Instantiates {@link #arr1} as <code>pArr1</code> and {@link #arr2} as <code>pArr2</code>.
     ...
     * {@link #linReg(double[],double[]) the linear equation defined by pArr1, and pArr2}.
     * @param pVal      The value to set "y" to when evaluating the equation generated by {@link #linReg()}.
    ...
    public static Set resid(double[] pArr1,
        ...
        for(int x = 0; x < pArr1.length; x++)
            resid[x] = pred(pArr1[x], pEq) - pArr2[x];
