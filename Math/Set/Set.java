...
public class Set implements MathObject{
     ...
     * <code>pVal</code> and {@link #linReg() a linear equation} to
    ...
    /**
     * Predicts the estimated value of the "yhat" using the the equation generated by {@link #linReg()}. Passes
     * <code>pVal</code>, {@link #linReg() a linear equation}, and <code>toSolve</code> to
     ...
     * @return the {@link #resid()} residules of {@link #arr1} and {@link #arr2}.
     */
    public Set es() {
        return resid();
    }
    /**
     * Returns the residules of {@link #arr1} and {@link #arr2}.
     * @return the {@link #resid()} residules of {@link #arr1} and {@link #arr2}.
     */
    public Set resid() {
    ...
    /**
     * Returns the residules of <code>pArr1</code> and <code>pArr2</code>.
     ...
     * @return a Set created by the residules of <code>pArr1</code> and <code>pArr2</code>.
     */
    ...
    /**
     * Returns a {@link EquationSystem polynomial equation} based off of {@link #arr1} and
    ...
    /**
     * Returns a {@link EquationSystem linear equation} based off this classes {@link #arr1} and {@link #arr2}.
    ...
    /**
     * Returns a {@link EquationSystem linear equation} based off <code>pArr1</code> and <code>pArr2</code>.
    ...
    /**
     * Returns the correlation coeffecient for {@link #arr1} and {@link #arr2} by passing them to the
    ...
    /**
     * Returns the Correlation coeffecient for <code>pArr1</code> and <code>pArr2</code>. <br>Note that the cardinality
     * of <code>pArr1</code> and <code>pArr2</code> has to be equal.
    ...
    /**
     * Returns the Coefficient of determination of {@link #arr1} and {@link #arr2}. Passes {@link #arr1} and
     * {@link #arr2} to {@link #R2(double[],double[]) the main R2 function}.
    ...
    /**
     * Returns the Coefficient of determination of <code>pArr1</code> and <code>pArr2</code>.
    ...
    /**
     * Returns the length of {@link #arr1}. Effectively just an alias for <code>arr1.length</code>.
    ...
    /**
     * Returns the length of <code>pArr1</code>. Effectively just an alias for <code>pArr1.length</code>.
    ...
    /**
     * Finds the "Z - Score" of <code>x</code> by passing <code>x</code> and {@link #arr1} to
    ...
    /**
     * Finds the "Z - Score" of <code>x</code> and <code>pArr1</code>.
     * @param x         The number to find the "Z - Score" of.
    ...
    /**
     * Returns a "normalized" version of {@link #arr1} - it replaces each element with their
    ...
    /**
     * Returns the average (mean) of {@link #arr1}.
    ...
    /**
     * Returns the average (mean) value of <code>pArr1</code>.
     * @param pArr1         The array whose average (mean) will be returned.
     * @return The average (mean) of <code>pArr1</code>.
    ...
    /**
     * Returns the outliers of {@link #arr1}. Just passes {@link #arr1} to
