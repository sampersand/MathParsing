...
public class f extends CustomFunction{
    ...
    @Override
    public HashMap<String, DoubleSupplier> exec(HashMap<String, DoubleSupplier> hm, EquationSystem pEqSys, TokenNode pNode) {
        ...
        //  HashMap<String, DoubleSupplier> rethm = (HashMap<String, DoubleSupplier>)rargs[1];
        //  double ret = 0;
        //  for(double val : args)
        //      if(val != 0)
        //          ret += 1D / val;
